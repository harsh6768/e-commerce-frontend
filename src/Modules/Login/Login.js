				...
				<div className="login-page-container card  mx-auto d-flex  mt-5">
					<div className="row card-body">
						...
						<div className="col-md-6 mx-auto">
							...
							<input  className='form-control'  type="email" name='email' value={email} placeholder="Enter email" onChange={this.onHandleChange} />
							</div>
							<div className='form-group'>
								<input  className='form-control' type="password" name='password' value={password} placeholder="Enter password" onChange={this.onHandleChange} />
							</div>
